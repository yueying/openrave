...
namespace OpenRAVE {
	...
	void RobotBase::GripperInfo::SerializeJSON(rapidjson::Value &value,
	...
	void RobotBase::AttachedSensorInfo::SerializeJSON(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator, dReal unit_scale, int options) const
	{
		value.SetObject();
	...
	bool RobotBase::Init(const std::vector<KinBody::LinkInfoConstPtr>& linkinfos,
		...
		const std::vector<ConnectedBodyInfoConstPtr>& connectedbodyinfos,
