...
protected:
    ...
    {
public:
        JSONReaderFunctionData(InterfaceType type, const std::string& id, const CreateJSONReaderFn& fn, std::shared_ptr<RaveGlobal> global) : _global(global), _type(type), _id(id)
        {
            boost::mutex::scoped_lock lock(global->_mutexinternal);
