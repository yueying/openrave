...
{
public:
	ItemSelectionCallbackData(const ViewerBase::ItemSelectionCallbackFn& callback, std::shared_ptr<QtCoinViewer> pviewer)
		: _callback(callback), _pweakviewer(pviewer) {
	}
...
{
public:
	ViewerImageCallbackData(const ViewerBase::ViewerImageCallbackFn& callback, std::shared_ptr<QtCoinViewer> pviewer)
		: _callback(callback), _pweakviewer(pviewer) {
	}
...
{
public:
	ViewerThreadCallbackData(const ViewerBase::ViewerThreadCallbackFn& callback, std::shared_ptr<QtCoinViewer> pviewer)
		: _callback(callback), _pweakviewer(pviewer) {
	}
