...
typedef std::shared_ptr<fcl::BroadPhaseCollisionManager<double>> BroadPhaseCollisionManagerPtr;
typedef std::weak_ptr<fcl::BroadPhaseCollisionManager<double>> BroadPhaseCollisionManagerWeakPtr;
