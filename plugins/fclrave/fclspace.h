...
public:
    ...
    KinBodyInfoPtr InitKinBody(KinBodyConstPtr pbody, KinBodyInfoPtr pinfo = KinBodyInfoPtr())
    {
        ...
        FOREACHC(itlink, pbody->GetLinks())
		{
            ...
            std::shared_ptr<KinBodyInfo::LinkInfo> link(new KinBodyInfo::LinkInfo(*itlink));
            ...
            for(GeometryInfoIterator itgeominfo = begingeom; itgeominfo != endgeom; ++itgeominfo) {
                ...
                CollisionObjectPtr pfclcoll = std::make_shared<fcl::CollisionObject<double>>(pfclgeom);
            ...
            if( link->vgeoms.size() == 0 ) {
                ...
                CollisionObjectPtr pfclcollBV = std::make_shared<fcl::CollisionObject<double>>(pfclgeomBV);
...
private:
    ...
    static TransformCollisionPair _CreateTransformCollisionPairFromOBB(fcl::OBB<double> const &bv) {
        ...
        CollisionObjectPtr pbvColl = std::make_shared<fcl::CollisionObject<double>>(pbvGeom);
