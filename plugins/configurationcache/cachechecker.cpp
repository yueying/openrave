...
public:
    ...
    {
        RegisterCommand("TrackRobotState",std::bind(&CacheCollisionChecker::_TrackRobotStateCommand,this,_1,_2),
                        "set up the cache to track a body state. [bodyname affinedofs]");
        RegisterCommand("GetTrackedRobot",std::bind(&CacheCollisionChecker::_GetTrackedRobotCommand,this,_1,_2),
                        "get the robot being tracked by the collisionchecker");
        RegisterCommand("GetCacheStatistics",std::bind(&CacheCollisionChecker::_GetCacheStatisticsCommand,this,_1,_2),
                        "get the cache statistics: cachecollisions, cachehits");
        RegisterCommand("GetSelfCacheStatistics",std::bind(&CacheCollisionChecker::_GetSelfCacheStatisticsCommand,this,_1,_2),
                        "get the self collision cache statistics: selfcachecollisions, selfcachehits");
        RegisterCommand("SetSelfCacheParameters",std::bind(&CacheCollisionChecker::_SetSelfCacheParametersCommand,this,_1,_2),
                        "set the self collision cache parameters: collisionthreshold, freespacethreshold, insertiondistancemultiplier, base");
        RegisterCommand("SetCacheParameters",std::bind(&CacheCollisionChecker::_SetCacheParametersCommand,this,_1,_2),
                        "set the collision cache parameters: collisionthreshold, freespacethreshold, insertiondistancemultiplier, base");
        RegisterCommand("ValidateCache",std::bind(&CacheCollisionChecker::_ValidateCacheCommand,this,_1,_2),
                        "test the validity of the cache");
        RegisterCommand("ValidateSelfCache",std::bind(&CacheCollisionChecker::_ValidateSelfCacheCommand,this,_1,_2),
                        "test the validity of the self collision cache");
        RegisterCommand("ResetCache",std::bind(&CacheCollisionChecker::_ResetCacheCommand,this,_1,_2),
                        "reset collision cache");
        RegisterCommand("ResetSelfCache",std::bind(&CacheCollisionChecker::_ResetSelfCacheCommand,this,_1,_2),
                        "reset self collision cache");
        RegisterCommand("UpdateCollisionConfigurations",std::bind(&CacheCollisionChecker::_UpdateCollisionConfigurationsCommand,this,_1,_2),
                        "remove all nodes in collision with this body. [bodyname]");
        RegisterCommand("UpdateFreeConfigurations",std::bind(&CacheCollisionChecker::_UpdateFreeConfigurationsCommand,this,_1,_2),
                        "remove all free nodes that overlap with this body. [bodyname]");
        RegisterCommand("SaveCache",std::bind(&CacheCollisionChecker::_SaveCacheCommand,this,_1,_2),
                        "save self collision cache");
        RegisterCommand("LoadCache",std::bind(&CacheCollisionChecker::_LoadCacheCommand,this,_1,_2),
                        "load self collision cache");
        RegisterCommand("GetCacheTimes",std::bind(&CacheCollisionChecker::_GetCacheTimesCommand,this,_1,_2),
...
protected:
    virtual bool _TrackRobotStateCommand(std::ostream& sout, std::istream& sinput)
    {
        ...
        _handleRobotDOFChange = _probot->RegisterChangeCallback(KinBody::Prop_RobotActiveDOFs, std::bind(&CacheCollisionChecker::_UpdateRobotDOF, this));
