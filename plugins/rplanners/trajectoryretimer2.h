...
class TrajectoryRetimer2 : public PlannerBase
{
protected:
    class GroupInfo
    {
        ...
        if( numpoints > 1 ) {
            ...
            if( _cachedoldspec != _parameters->_configurationspecification || posinterpolation != _cachedposinterpolation ) {
                ...
                for(size_t i = 0; i < _cachednewspec._vgroups.size(); ++i) {
                    ...
                    _listgroupinfo.back()->_vConfigVelocityLimit = std::vector<dReal>(_parameters->config_velocity_limit_vector_.begin()+itgroup->offset, _parameters->config_velocity_limit_vector_.begin()+itgroup->offset+itgroup->dof);
                    ...
                    _listgroupinfo.back()->_vConfigLowerLimit = std::vector<dReal>(_parameters->config_lower_limit_vector_.begin()+itgroup->offset, _parameters->config_lower_limit_vector_.begin()+itgroup->offset+itgroup->dof);
                    _listgroupinfo.back()->_vConfigUpperLimit = std::vector<dReal>(_parameters->config_upper_limit_vector_.begin()+itgroup->offset, _parameters->config_upper_limit_vector_.begin()+itgroup->offset+itgroup->dof);
...

                    {
                        ...
                        if( igrouptype == 0 ) {
                            _listmintimefns.push_back(boost::bind(&TrajectoryRetimer2::_ComputeMinimumTimeJointValues,this,_listgroupinfo.back(),_1,_2,_3,_4));
                        }
                        else if( igrouptype == 1 ) {
                            _listmintimefns.push_back(boost::bind(&TrajectoryRetimer2::_ComputeMinimumTimeAffine,this,_listgroupinfo.back(),affinedofs,_1,_2,_3,_4));
                        }
                        else if( igrouptype == 2 ) {
                            _listmintimefns.push_back(boost::bind(&TrajectoryRetimer2::_ComputeMinimumTimeIk,this,_listgroupinfo.back(),iktype,_1,_2,_3,_4));
                        }
                    }

                    if( igrouptype == 0 ) {
                        if( _parameters->_hasvelocities ) {
                            _listcheckvelocityfns.push_back(boost::bind(&TrajectoryRetimer2::_CheckJointValues,this,_listgroupinfo.back(),_1,_2,_3));
                        }
                        else {
                            _listvelocityfns.push_back(boost::bind(&TrajectoryRetimer2::_ComputeVelocitiesJointValues,this,_listgroupinfo.back(),_1,_2,_3));
                        }
                        _listwritefns.push_back(boost::bind(&TrajectoryRetimer2::_WriteJointValues,this,_listgroupinfo.back(),_1,_2,_3));
                    }
                    else if( igrouptype == 1 ) {
                        if( _parameters->_hasvelocities ) {
                            _listcheckvelocityfns.push_back(boost::bind(&TrajectoryRetimer2::_CheckAffine,this,_listgroupinfo.back(),affinedofs,_1,_2,_3));
                        }
                        else {
                            _listvelocityfns.push_back(boost::bind(&TrajectoryRetimer2::_ComputeVelocitiesAffine,this,_listgroupinfo.back(),affinedofs,_1,_2,_3));
                        }
                        _listwritefns.push_back(boost::bind(&TrajectoryRetimer2::_WriteAffine,this,_listgroupinfo.back(),affinedofs,_1,_2,_3));
                    }
                    else if( igrouptype == 2 ) {
                        if( _parameters->_hasvelocities ) {
                            _listcheckvelocityfns.push_back(boost::bind(&TrajectoryRetimer2::_CheckIk,this,_listgroupinfo.back(),iktype,_1,_2,_3));
                        }
                        else {
                            _listvelocityfns.push_back(boost::bind(&TrajectoryRetimer2::_ComputeVelocitiesIk,this,_listgroupinfo.back(),iktype,_1,_2,_3));
                        }
                        _listwritefns.push_back(boost::bind(&TrajectoryRetimer2::_WriteIk,this,_listgroupinfo.back(),iktype,_1,_2,_3));
                    }
