...
public:
        ...
        virtual ProcessElement startElement(const std::string& name, const AttributesList& atts)
        {
            ...
            static std::array<string, 16> tags = { { "sensor", "minangle", "min_angle", "maxangle", "max_angle", "maxrange", "max_range", "minrange", "min_range", "scantime", "color", "time_scan", "time_increment", "power","resolution"}};
