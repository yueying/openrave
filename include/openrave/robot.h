...
namespace OpenRAVE
{
	/** \brief <b>[interface]</b> A robot is a kinematic body that has attached manipulators, 
	    sensors, and controllers. <b>If not specified, method is not multi-thread safe.</b> See \ref arch_robot.
		\ingroup interfaces
	 */
