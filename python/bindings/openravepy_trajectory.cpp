...
PyTrajectoryBase::PyTrajectoryBase(TrajectoryBasePtr pTrajectory, PyEnvironmentBasePtr pyenv)
	: PyInterfaceBase(pTrajectory, pyenv),_ptrajectory(pTrajectory) 
{
}
...
void PyTrajectoryBase::Insert(size_t index, object odata, 
	PyConfigurationSpecificationPtr pyspec, bool bOverwrite)
{
    std::vector<dReal> vdata = ExtractArray<dReal>(odata);
...
void PyTrajectoryBase::Insert(size_t index, object odata,
	std::shared_ptr<ConfigurationSpecification::Group> pygroup)
{
    PyConfigurationSpecificationPtr pyspec(new PyConfigurationSpecification(*pygroup));
...
void PyTrajectoryBase::Insert(size_t index, object odata, 
	std::shared_ptr<ConfigurationSpecification::Group> pygroup, bool bOverwrite)
{
    PyConfigurationSpecificationPtr pyspec(new PyConfigurationSpecification(*pygroup));
...
object PyTrajectoryBase::SampleFromPrevious(object odata, dReal time, 
	std::shared_ptr<ConfigurationSpecification::Group> pygroup) const
{
    PyConfigurationSpecificationPtr pyspec(new PyConfigurationSpecification(*pygroup));
