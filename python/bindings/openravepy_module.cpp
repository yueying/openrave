...
#endif
{
    ...
    class_<PyModuleBase, std::shared_ptr<PyModuleBase>, PyInterfaceBase>(m, "Module", DOXY_CLASS(ModuleBase))
    .def(init<ModuleBasePtr, PyEnvironmentBasePtr>(), "module"_a, "env"_a)
#else
    class_<PyModuleBase, std::shared_ptr<PyModuleBase>, bases<PyInterfaceBase> >("Module", DOXY_CLASS(ModuleBase), no_init)
#endif
