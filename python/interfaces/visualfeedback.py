...
log = logging.getLogger('openravepy.interfaces.VisualFeedback')
...
class VisualFeedback:
    ...
    def SetCameraAndTarget(self, sensorindex=None, sensorname=None, manipname=None, convexdata=None, sensorrobot=None,
                           targetlink=None, targetgeomname=None, raydensity=None):
    ...
    def MoveToObserveTarget(self, affinedofs=None, smoothpath=None, planner=None, sampleprob=None, maxiter=None,
                            execute=None, outputtraj=None):
    ...
    def VisualFeedbackGrasping(self, graspset, usevisibility=None, planner=None, graspdistthresh=None,
                               visgraspthresh=None, numgradientsamples=None, maxiter=None, execute=None,
                               outputtraj=None):
