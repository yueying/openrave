...
class SimpleNavigationPlanning:
    ...
    def performNavigationPlanning(self):
        ...
        while True:
            ...
            h = self.env.drawlinelist(transpose(c_[
                                                    center - xaxis, center + xaxis, center - yaxis, center + yaxis, center + xaxis, center + 0.5 * xaxis + 0.5 * yaxis, center + xaxis, center + 0.5 * xaxis - 0.5 * yaxis]),
                                      linewidth=5.0, colors=array((0, 1, 0)))
